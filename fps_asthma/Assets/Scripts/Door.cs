...
{
    public Transform doorModel; //sliding door
    public GameObject colObject; //activate or deactivate the collider
    public float openSpeed; //how fast door slides open
